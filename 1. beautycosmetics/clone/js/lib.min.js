...
! function (e) {
  ...
  var r = function () {
    ...
    return n(e, null, [{
      ...
      value: function (e) {
        ...
        return "POST" !== n.method && "PUT" !== n.method || (n.body = void 0 === i.data ? null : JSON.stringify(i.data)), void 0 !== i.cid && (n.headers.X_CID = void 0 === i.cid ? "" : i.cid), new Promise(function (i, r) {
      ...
      value: function () {
        for (var e = new ClientJS, t = "", i = e.getBrowserData().ua, n = e.getCanvasPrint(), r = "&CustomFingerprint=" + e.getCustomFingerprint(i, n).toString(), o = "", a = [{
          ...
          var l = e[a[s].fn](),
            u = a[s].name;
          l = l ? l.toString() : "n/a", o = o + "&" + u + "=" + encodeURIComponent(l)
        }
        o = (o += r).substring(1);
        try {
          t = window.btoa(o)
      ...
      value: function (e, t) {
        if (this._isNullOrEmpty(e.shippingMethodId) && this._logOrderErrorData("shippingMethodId field is not valid!"), this._isNullOrEmpty(e.productId) && this._logOrderErrorData("productId field is not valid!"), this._isNullOrEmpty(e.funnelBoxId)) return this._logOrderErrorData("funnelBoxId field is not valid!");
        if (this._isNullOrEmpty(t) && this._logOrderErrorData("paymentType field is not valid!"), "paypal" === t.toLowerCase()) void 0 === e.payment.paymentProcessorId && (e.payment = {
          paymentProcessorId: 5
        }), e.shippingAddress = null;
        else if ("boleto" === t.toLowerCase()) e.payment = {
          paymentProcessorId: 25
        }, e.shippingAddress = null;
        else if ("creditcard" === t.toLowerCase()) {
          if (this._isNullOrEmpty(e.customer.email) && this._logOrderErrorData("customer email field is not valid!"), this._isNullOrEmpty(e.customer.firstName) && this._isNullOrEmpty(e.shippingAddress.firstName) && this._logOrderErrorData("firstname field is not valid!"), this._isNullOrEmpty(e.customer.lastName) && this._isNullOrEmpty(e.shippingAddress.lastName) && this._logOrderErrorData("lastname field is not valid!"), this._isNullOrEmpty(e.payment.name) && this._isNullOrEmpty(e.payment.cardId)) {
            var i = this._isNullOrEmpty(e.customer.firstName) ? e.shippingAddress.firstName : e.customer.firstName,
              n = this._isNullOrEmpty(e.customer.lastName) ? e.shippingAddress.lastName : e.customer.lastName;
            e.payment.name = i + " " + n
          }
          this._isNullOrEmpty(e.payment.creditcard) && this._logOrderErrorData("creditcard field is not valid!"), this._isNullOrEmpty(e.payment.creditCardBrand) && this._logOrderErrorData("creditCardBrand field is not valid!"), this._isNullOrEmpty(e.payment.expiration) && this._logOrderErrorData("expiration field is not valid!"), this._isNullOrEmpty(e.payment.cvv) && this._logOrderErrorData("cvv field is not valid!"), !1 === e.useShippingAddressForBilling && null == e.billingAddress && this._logOrderErrorData("useShippingAddressForBilling equals false and billingAddress object is not valid!"), this._isNullOrEmpty(e.shippingAddress.firstName) && (e.shippingAddress.firstName = e.customer.firstName), this._isNullOrEmpty(e.shippingAddress.lastName) && (e.shippingAddress.lastName = e.customer.lastName), this._isNullOrEmpty(e.shippingAddress.address1) && this._logOrderErrorData("shippingAddres address1 field is not valid!"), this._isNullOrEmpty(e.shippingAddress.city) && this._logOrderErrorData("shippingAddres city field is not valid!"), this._isNullOrEmpty(e.shippingAddress.countryCode) && this._logOrderErrorData("shippingAddres countryCode field is not valid!"), (this._isNullOrEmpty(e.shippingAddress.state) || "N/A" == e.shippingAddress.state || "-" == e.shippingAddress.state) && (e.shippingAddress.state = e.shippingAddress.countryCode), e.useShippingAddressForBilling || (this._isNullOrEmpty(e.billingAddress.firstName) && (e.billingAddress.firstName = e.shippingAddress.firstName), this._isNullOrEmpty(e.billingAddress.lastName) && (e.billingAddress.lastName = e.shippingAddress.lastName), this._isNullOrEmpty(e.billingAddress.address1) && this._logOrderErrorData("billingAddress address1 field is not valid!"), this._isNullOrEmpty(e.billingAddress.city) && this._logOrderErrorData("billingAddress city field is not valid!"), this._isNullOrEmpty(e.billingAddress.countryCode) && this._logOrderErrorData("billingAddress countryCode field is not valid!"), (this._isNullOrEmpty(e.billingAddress.state) || "N/A" == e.billingAddress.state || "-" == e.billingAddress.state) && (e.billingAddress.state = e.billingAddress.countryCode))
        }
        return location.href.indexOf("?") > 0 && (e.payment.callBackParam = encodeURI(location.href.substr(location.href.indexOf("?")))), e
      }
    }, {
      ...
      key: "antiFraud",
      value: function (e) {
        fetch("https://emanage-prod-antifraud-api.azurewebsites.net/api/risk/kount/collectorConfig").then(function (e) {
          return e.json()
        }).then(function (t) {
          e(t)
        }).catch(function (e) {
      ...
      value: function (e) {
        ...
        return {
          get: function (e) {
            return "undefined" != typeof Storage ? window.localStorage.getItem(e) : (console.log("Sorry! No Web Storage support ...."), null)
          },
          set: function (e, t) {
            "undefined" != typeof Storage ? window.localStorage.setItem(e, t) : console.log("Sorry! No Web Storage support ...")
          },
          remove: function (e) {
      ...
      key: "redirectPage",
      value: function (e, t) {
        var i = location.search.length > 0 ? location.search.substr(1) : "";
        return e.indexOf("?") > 0 ? e += "" !== i ? "&" + i : "" : e += "" !== i ? "?" + i : "", "_blank" == t ? window.open(e) : window.location = e, !1
      }
    }]), e
  }();
  t.default = r
  ...
  var s = function () {
    function e() {
      ...
      ! function (e, t) {
        if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
      }(this, e), this.webkey = t, this.cid = i, this.isTest = n, this.baseAPIEndpoint = void 0 !== r ? r : "https://sales-prod.tryemanagecrm.com/api"
    }
    return r(e, [{
      key: "placeOrder",
      value: function (e, t, i) {
        if (e && "" !== e) {
          ...
          this.isTest && (n.indexOf("?") > 0 ? n += "&behaviorId=2" : n += "?behaviorId=2");
          var r = this._beforeSubmitMainOrder(e, t);
          null != r ? a.default.callAjax(n, {
            cid: this.cid,
            method: "POST",
            data: r
          }).then(function (e) {
      ...
      value: function (e, t, i, n) {
        if (t && "" !== t) {
          this.isTest && (e.indexOf("?") > 0 ? e += "&behaviorId=2" : e += "?behaviorId=2");
          var r = this._beforeSubmitMainOrder(t, i);
          null != r ? a.default.callAjax(e, {
            cid: this.cid,
            method: "POST",
            data: r
          }).then(function (e) {
      ...
      value: function (e, t) {
        if (e && "" !== e.toString().trim()) {
          var i = this.baseAPIEndpoint + "/orders/" + e + "/relatedorders";
          a.default.callAjax(i, {
            cid: this.cid
          }).then(function (e) {
      ...
      value: function (e, t) {
        var i = this,
          n = void 0;
        try {
          n = JSON.parse(a.default.localStorage().get("antiFraud"))
        } catch (e) {
        ...
        var r = {
            ...
            shippingAddress: {},
            billingAddress: null,
            analyticsV2: a.default.makeClientFingerPrint(),
            funnelBoxId: "",
            antiFraud: {
          ...
          o = Object.assign(r, e);
        try {
          var s = window.localStorage.getItem("campproducts");
          if (s) {
            var l = (s = JSON.parse(s)).camps.filter(function (e) {
              return e[i.webkey]
            });
            if (l && l.length > 0) {
              var u = l[0][this.webkey].location;
              o.customer.IP = u.ip, o.customer.Location = {
        ...
        return a.default.validateOrderData(o, t)
      }
    }, {
      ...
      value: function (e) {
        var t = void 0;
        try {
          t = JSON.parse(a.default.localStorage().get("antiFraud"))
        } catch (e) {
        ...
        try {
          ...
          if (r && o) {
            var s = (r = JSON.parse(r)).camps.filter(function (e) {
              return e[o]
            });
            if (s && s.length > 0) {
              var l = s[0][o].location;
              n.customer.IP = l.ip, n.customer.Location = {
        ...
        return n.productId && "" !== n.productId && 0 !== n.productId ? n : null
      }
    }, {
      ...
      value: function (e, t, i) {
        if (e && "" !== e)
          if (t && "" !== t) {
            var n = this.baseAPIEndpoint + "/orders/" + this.webkey + "?trackingNumber=" + e;
            this.isTest && (n.indexOf("?") > 0 ? n += "&isTest=true" : n += "?isTest=true"), a.default.callAjax(n, {
              cid: this.cid,
              method: "PUT",
              data: t
            }).then(function (e) {
      ...
      value: function (e, t) {
        if (e && void 0 !== e.email) {
          ...
          e.analyticsV2 = a.default.makeClientFingerPrint(), a.default.callAjax(i, {
            cid: this.cid,
            method: "POST",
            data: e
          }).then(function (e) {
  ...
  var s = function () {
    function e() {
      ...
      ! function (e, t) {
        if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
      }(this, e), this.webkey = t, this.cid = i, this.baseAPIEndpoint = void 0 !== n ? n : "https://websales-api.tryemanagecrm.com/api"
    }
    return r(e, [{
      key: "getUpsells",
      value: function (e) {
        a.default.callAjax(this.baseAPIEndpoint + "/campaigns/" + this.webkey + "/upsells", {
          cid: this.cid
        }).then(function (t) {
      ...
      key: "getLocation",
      value: function (e) {
        a.default.callAjax(this.baseAPIEndpoint + "/campaigns/" + this.webkey + "/customers/location", {
          cid: this.cid
        }).then(function (t) {
          "function" == typeof e && e(t)
        }).catch(function (t) {
      ...
      value: function (e) {
        var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null,
          i = t && "" !== t ? this.baseAPIEndpoint + "/campaigns/" + this.webkey + "/countries/" + t : this.baseAPIEndpoint + "/campaigns/" + this.webkey + "/countries";
        a.default.callAjax(i, {
          cid: this.cid
        }).then(function (t) {
          "function" == typeof e && e(t)
      ...
      value: function (e, t) {
        var i = "https://cdn-sgn.dfowebsys-h01.com/states/" + e.toLowerCase() + ".json";
      ...
      key: "getProducts",
      value: function (e) {
        var t = this.baseAPIEndpoint + "/campaigns/" + this.webkey + "/products/prices";
        a.default.callAjax(t, {
          cid: this.cid
        }).then(function (t) {
          "function" == typeof e && e(t)
        }).catch(function (t) {
      ...
      value: function (e) {
        var t = "https://sales-api.tryemanagecrm.com/api/campaigns/" + this.webkey + "/products/all/miniupsells";
        a.default.callAjax(t, {
          cid: this.cid
        }).then(function (t) {
          "function" == typeof e && e(t)
      ...
      value: function (e, t) {
        var i = "https://sales-api.tryemanagecrm.com/api/campaigns/" + this.webkey + "/products/" + e + "/miniupsells";
        a.default.callAjax(i, {
          cid: this.cid
        }).then(function (e) {
          "function" == typeof t && t(e)
  ...
  function p() {
    return this.bodyUsed = !1, this._initBody = function (e) {
      ...
      var e, t, i, n = c(this);
      if (n) return n;
      if (this._bodyBlob) return e = this._bodyBlob, t = new FileReader, i = d(t), t.readAsText(e), i;
  ...
  function g(e, t) {
    ...
    if (e instanceof g) {
      ...
      this.url = e.url, this.credentials = e.credentials, t.headers || (this.headers = new u(e.headers)), this.method = e.method, this.mode = e.mode, this.signal = e.signal, r || null == e._bodyInit || (r = e._bodyInit, e.bodyUsed = !0)
    } else this.url = String(e);
    if (this.credentials = t.credentials || this.credentials || "same-origin", !t.headers && this.headers || (this.headers = new u(t.headers)), this.method = (i = t.method || this.method || "GET", n = i.toUpperCase(), m.indexOf(n) > -1 ? n : i), this.mode = t.mode || this.mode || null, this.signal = t.signal || this.signal, this.referrer = null, ("GET" === this.method || "HEAD" === this.method) && r) throw new TypeError("Body not allowed for GET or HEAD requests");
    this._initBody(r)
  }
  ...
  A.polyfill = !0, self.fetch || (self.fetch = A, self.Headers = u, self.Request = g, self.Response = y)
}, function (e, t, i) {
  ...
  (function (t, i) {
    ...
    n = function () {
      ...
      d ? w = function () {
        return t.nextTick(m)
      } : c ? (v = 0, y = new c(m), b = document.createTextNode(""), y.observe(b, {
        characterData: !0
      }), w = function () {
        b.data = v = ++v % 2
      }) : h ? ((g = new MessageChannel).port1.onmessage = m, w = function () {
      ...
      function O(t, i, n) {
        i.constructor === t.constructor && n === A && i.constructor.resolve === E ? function (e, t) {
          t._state === T ? N(e, t._result) : t._state === k ? B(e, t._result) : j(t, void 0, function (t) {
            return x(e, t)
          }, function (t) {
            return B(e, t)
          })
        }(t, i) : n === I ? (B(t, I.error), I.error = null) : void 0 === n ? N(t, i) : e(n) ? function (e, t, i) {
          s(function (e) {
            var n = !1,
              r = function (e, t, i, n) {
                try {
      ...
      function x(e, t) {
        var i, n;
        e === t ? B(e, new TypeError("You cannot resolve a promise with itself")) : (n = typeof (i = t), null === i || "object" !== n && "function" !== n ? N(e, t) : O(e, t, _(t)))
      }
      ...
      function N(e, t) {
        e._state === C && (e._result = t, e._state = T, 0 !== e._subscribers.length && s(L, e))
      }

      function B(e, t) {
        e._state === C && (e._state = k, e._result = t, s(M, e))
      }

      function j(e, t, i, n) {
        var r = e._subscribers,
          o = r.length;
        e._onerror = null, r[o] = t, r[o + T] = i, r[o + k] = n, 0 === o && e._state && s(L, e)
      }
      ...
      function L(e) {
        var t = e._subscribers,
          i = e._state;
        if (0 !== t.length) {
          for (var n = void 0, r = void 0, o = e._result, a = 0; a < t.length; a += 3) n = t[a], r = t[a + i], n ? U(i, n, r, o) : r(o);
      ...
      function U(t, i, n, r) {
        ...
        if (o) {
          if ((a = function (e, t) {
            ...
            }(n, r)) === I ? (u = !0, s = a.error, a.error = null) : l = !0, i === a) return void B(i, new TypeError("A promises callback cannot return that same promise."))
        } else a = r, l = !0;
        i._state !== C || (o && l ? x(i, a) : u ? B(i, s) : t === T ? N(i, a) : t === k && B(i, a))
      }
      var D = 0;
      ...
      var R = function () {
        ...
        return e.prototype._enumerate = function (e) {
          ...
          var n = this.promise;
          n._state === C && (this._remaining--, e === k ? B(n, i) : this._result[t] = i), 0 === this._remaining && N(n, this._result)
      ...
      var V = function () {
        function t(e) {
          this[S] = D++, this._result = this._state = void 0, this._subscribers = [], P !== e && ("function" != typeof e && function () {
      ...
      return V.prototype.then = A, V.all = function (e) {
      ...
      }, V.resolve = E, V.reject = function (e) {
        var t = new this(P);
        return B(t, e), t
  ...
  var n, r, o, a;
  n = window, (a = function () {
    return r = (new(window.UAParser || t.UAParser)).getResult(), o = new u, this
  }).prototype = {
    ...
    getFingerprint: function () {
      return c(r.ua + "|" + this.getScreenPrint() + "|" + this.getPlugins() + "|" + this.getFonts() + "|" + this.isLocalStorage() + "|" + this.isSessionStorage() + "|" + this.getTimeZone() + "|" + this.getLanguage() + "|" + this.getSystemLanguage() + "|" + this.isCookie() + "|" + this.getCanvasPrint(), 256)
    },
    ...
    getFlashVersion: function () {
      return this.isFlash() ? (objPlayerVersion = d.getFlashPlayerVersion(), objPlayerVersion.major + "." + objPlayerVersion.minor + "." + objPlayerVersion.release) : ""
    },
  ...
  }, "object" == typeof e && void 0 !== t && (e.exports = a), n.ClientJS = a;
  var l = function () {
      function e(e) {
      ...
      var n, r = "codebase code name archive object width height alt align hspace vspace".split(" ").concat(i);
      try {
      ...
      var o = {
        ...
        getJREs: function () {
          ...
          if (this.isPluginInstalled())
            for (var i = this.getPlugin().jvms, n = 0; n < i.getLength(); n++) t[n] = i.get(n).version;
          else "MSIE" == (i = this.getBrowser()) ? this.testUsingActiveX("1.7.0") ? t[0] = "1.7.0" : this.testUsingActiveX("1.6.0") ? t[0] = "1.6.0" : this.testUsingActiveX("1.5.0") ? t[0] = "1.5.0" : this.testUsingActiveX("1.4.2") ? t[0] = "1.4.2" : this.testForMSVM() && (t[0] = "1.1") : "Netscape Family" == i && (this.getJPIVersionUsingMimeType(), null != this.firefoxJavaVersion ? t[0] = this.firefoxJavaVersion : this.testUsingMimeTypes("1.7") ? t[0] = "1.7.0" : this.testUsingMimeTypes("1.6") ? t[0] = "1.6.0" : this.testUsingMimeTypes("1.5") ? t[0] = "1.5.0" : this.testUsingMimeTypes("1.4.2") ? t[0] = "1.4.2" : "Safari" == this.browserName2 && (this.testUsingPluginsArray("1.7.0") ? t[0] = "1.7.0" : this.testUsingPluginsArray("1.6") ? t[0] = "1.6.0" : this.testUsingPluginsArray("1.5") ? t[0] = "1.5.0" : this.testUsingPluginsArray("1.4.2") && (t[0] = "1.4.2")));
          if (this.debug)
        ...
        installJRE: function (e, t) {
          if (this.isPluginInstalled() && this.isAutoInstallEnabled(e)) {
            var i;
            return (i = this.isCallbackSupported() ? this.getPlugin().installJRE(e, t) : this.getPlugin().installJRE(e)) && (this.refresh(), null != this.returnPage && (document.location = this.returnPage)), i
          }
          return this.installLatestJRE()
        },
        isAutoInstallEnabled: function (e) {
          if (!this.isPluginInstalled()) return !1;
          if (void 0 === e && (e = null), "MSIE" != l.browserName || l.compareVersionToPattern(l.getPlugin().version, ["10", "0", "0"], !1, !0)) e = !0;
          else if (null == e) e = !1;
          else {
            var t = "1.6.0_33+";
            if (null == t || 0 == t.length) e = !0;
              ...
              if ("+" != i && "*" != i && -1 != t.indexOf("_") && "_" != i && (t += "*", i = "*"), 0 < (t = t.substring(0, t.length - 1)).length) {
        ...
        installLatestJRE: function (e) {
          if (this.isPluginInstalled() && this.isAutoInstallEnabled()) {
            var i = !1;
            return (i = this.isCallbackSupported() ? this.getPlugin().installLatestJRE(e) : this.getPlugin().installLatestJRE()) && (this.refresh(), null != this.returnPage && (document.location = this.returnPage)), i
          }
          if (e = this.getBrowser(), i = navigator.platform.toLowerCase(), "true" == this.EAInstallEnabled && -1 != i.indexOf("win") && null != this.EarlyAccessURL) this.preInstallJREList = this.getJREs(), null != this.returnPage && (this.myInterval = setInterval("deployJava.poll()", 3e3)), location.href = this.EarlyAccessURL;
          else {
            if ("MSIE" == e) return this.IEInstall();
            if ("Netscape Family" == e && -1 != i.indexOf("win32")) return this.FFInstall();
        ...
        runApplet: function (t, i, n) {
          ...
          null == this.returnPage && (this.returnPage = document.location), null != r ? "?" != this.getBrowser() ? this.versionCheck(n + "+") ? this.writeAppletTag(t, i) : this.installJRE(n + "+") && (this.refresh(), location.href = document.location, this.writeAppletTag(t, i)) : this.writeAppletTag(t, i) : e("[runApplet()] Invalid minimumVersion argument to runApplet():" + n)
        },
        writeAppletTag: function (e, t) {
          var i = "<applet ",
            n = "",
            o = !0;
          for (var a in null != t && "object" == typeof t || (t = {}), e) {
            var s;
            e: {
              s = a.toLowerCase();
            ...
            s ? (i += " " + a + '="' + e[a] + '"', "code" == a && (o = !1)) : t[a] = e[a]
          }
          for (var c in a = !1, t) "codebase_lookup" == c && (a = !0), "object" != c && "java_object" != c && "java_code" != c || (o = !1), n += '<param name="' + c + '" value="' + t[c] + '"/>';
          a || (n += '<param name="codebase_lookup" value="false"/>'), o && (i += ' code="dummy"'), document.write(i + ">\n" + n + "\n</applet>")
        },
        versionCheck: function (t) {
          var i = 0,
            n = t.match("^(\\d+)(?:\\.(\\d+)(?:\\.(\\d+)(?:_(\\d+))?)?)?(\\*|\\+)?$");
          if (null != n) {
            for (var r = t = !1, o = [], a = 1; a < n.length; ++a) "string" == typeof n[a] && "" != n[a] && (o[i] = n[a], i++);
            for ("+" == o[o.length - 1] ? (r = !0, t = !1, o.length--) : "*" == o[o.length - 1] ? (r = !1, t = !0, o.length--) : 4 > o.length && (r = !1, t = !0), i = this.getJREs(), a = 0; a < i.length; ++a)
              if (this.compareVersionToPattern(i[a], o, t, r)) return !0
          } else e("[versionCheck()] " + (i = "Invalid versionPattern passed to versionCheck: " + t)), alert(i);
          return !1
        },
        isWebStartInstalled: function (t) {
          ...
          var i = !1;
          return null != t.match("^(\\d+)(?:\\.(\\d+)(?:\\.(\\d+)(?:_(\\d+))?)?)?$") ? i = this.versionCheck(t + "+") : (e("[isWebStartInstaller()] Invalid minimumVersion argument to isWebStartInstalled(): " + t), i = this.versionCheck("1.4.2+")), i
        },
        ...
        compareVersionToPattern: function (e, t, i, n) {
          ...
          if (null != r) {
            var o = 0;
            e = [];
            for (var a = 1; a < r.length; ++a) "string" == typeof r[a] && "" != r[a] && (e[o] = r[a], o++);
    ...
    u = function () {
      ...
      var n, r = {},
        o = {};
      for (n in e) i.style.fontFamily = e[n], t.appendChild(i), r[e[n]] = i.offsetWidth, o[e[n]] = i.offsetHeight, t.removeChild(i);
      this.detect = function (n) {
        var a, s = !1;
        for (a in e) {
          i.style.fontFamily = n + "," + e[a], t.appendChild(i);
          var l = i.offsetWidth != r[e[a]] || i.offsetHeight != o[e[a]];
          t.removeChild(i), s = s || l
        }
        return s
      }
    };
  ...
  function c(e, t) {
    var i, n, r, o, a;
    for (i = 3 & e.length, n = e.length - i, r = t, a = 0; a < n;) o = 255 & e.charCodeAt(a) | (255 & e.charCodeAt(++a)) << 8 | (255 & e.charCodeAt(++a)) << 16 | (255 & e.charCodeAt(++a)) << 24, ++a, r = 27492 + (65535 & (r = 5 * (65535 & (r = (r ^= o = 461845907 * (65535 & (o = (o = 3432918353 * (65535 & o) + ((3432918353 * (o >>> 16) & 65535) << 16) & 4294967295) << 15 | o >>> 17)) + ((461845907 * (o >>> 16) & 65535) << 16) & 4294967295) << 13 | r >>> 19)) + ((5 * (r >>> 16) & 65535) << 16) & 4294967295)) + ((58964 + (r >>> 16) & 65535) << 16);
    switch (o = 0, i) {
      case 3:
      ...
      case 1:
        r ^= 461845907 * (65535 & (o = (o = 3432918353 * (65535 & (o ^= 255 & e.charCodeAt(a))) + ((3432918353 * (o >>> 16) & 65535) << 16) & 4294967295) << 15 | o >>> 17)) + ((461845907 * (o >>> 16) & 65535) << 16) & 4294967295
    }
  ...
  var d = function () {
    ...
    function i(e) {
      if (void 0 !== S.addEventListener) S.addEventListener("load", e, !1);
      else if (void 0 !== P.addEventListener) P.addEventListener("load", e, !1);
      else if (void 0 !== S.attachEvent) ! function (e, t, i) {
            ...
            if (u = h(i))
              if (!f(I[t].swfVersion) || B.wk && 312 > B.wk)
                if (I[t].expressInstall && o()) {
                  (l = {}).data = I[t].expressInstall, l.width = u.getAttribute("width") || "0", l.height = u.getAttribute("height") || "0", u.getAttribute("class") && (l.styleclass = u.getAttribute("class")), u.getAttribute("align") && (l.align = u.getAttribute("align"));
                  for (var u, c = {}, d = (u = u.getElementsByTagName("param")).length, p = 0; p < d; p++) "movie" != u[p].getAttribute("name").toLowerCase() && (c[u[p].getAttribute("name")] = u[p].getAttribute("value"));
                  a(l, c, i, n)
                } else s(u), n && n(l);
            else m(i, !0), n && (l.success = !0, l.ref = r(i), n(l))
          } else m(i, !0), n && ((i = r(i)) && void 0 !== i.SetVariable && (l.success = !0, l.ref = i), n(l))
        }
    }

    function r(e) {
      var t = null;
      return (e = h(e)) && "OBJECT" == e.nodeName && (void 0 !== e.SetVariable ? t = e : (e = e.getElementsByTagName("object")[0]) && (t = e)), t
    }

    function o() {
      return !M && f("6.0.65") && (B.win || B.mac) && !(B.wk && 312 > B.wk)
    }
    ...
    function a(e, t, i, n) {
      ...
      var r = h(i);
      r && ("OBJECT" == r.nodeName ? (v = l(r), y = null) : (v = r, y = i), e.id = "SWFObjectExprInst", (void 0 === e.width || !/%$/.test(e.width) && 310 > parseInt(e.width, 10)) && (e.width = "310"), (void 0 === e.height || !/%$/.test(e.height) && 137 > parseInt(e.height, 10)) && (e.height = "137"), P.title = P.title.slice(0, 47) + " - Flash Player Installation", n = B.ie && B.win ? "ActiveX" : "PlugIn", n = "MMredirectURL=" + S.location.toString().replace(/&/g, "%26") + "&MMplayerType=" + n + "&MMdoctitle=" + P.title, t.flashvars = void 0 !== t.flashvars ? t.flashvars + "&" + n : n, B.ie && B.win && 4 != r.readyState && (i += "SWFObjectNew", (n = P.createElement("div")).setAttribute("id", i), r.parentNode.insertBefore(n, r), r.style.display = "none", function () {
    ...
    function l(e) {
      ...
      if (B.win && B.ie) t.innerHTML = e.innerHTML;
        ...
        for (var i = e.length, n = 0; n < i; n++) 1 == e[n].nodeType && "PARAM" == e[n].nodeName || 8 == e[n].nodeType || t.appendChild(e[n].cloneNode(!0));
      return t
    }
    ...
    function u(e, t, i) {
      ...
      if (r)
        if (void 0 === e.id && (e.id = i), B.ie && B.win) {
          var o, a = "";
          for (o in e) e[o] != Object.prototype[o] && ("data" == o.toLowerCase() ? t.movie = e[o] : "styleclass" == o.toLowerCase() ? a += ' class="' + e[o] + '"' : "classid" != o.toLowerCase() && (a += " " + o + '="' + e[o] + '"'));
          for (var s in o = "", t) t[s] != Object.prototype[s] && (o += '<param name="' + s + '" value="' + t[s] + '" />');
          r.outerHTML = '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"' + a + ">" + o + "</object>", _[_.length] = e.id, n = h(e.id)
        } else {
          for (var l in (s = P.createElement("object")).setAttribute("type", "application/x-shockwave-flash"), e) e[l] != Object.prototype[l] && ("styleclass" == l.toLowerCase() ? s.setAttribute("class", e[l]) : "classid" != l.toLowerCase() && s.setAttribute(l, e[l]));
          for (a in t) t[a] != Object.prototype[a] && "movie" != a.toLowerCase() && (e = s, o = a, l = t[a], (i = P.createElement("param")).setAttribute("name", o), i.setAttribute("value", l), e.appendChild(i));
    ...
    function f(e) {
      var t = B.pv;
      return (e = e.split("."))[0] = parseInt(e[0], 10), e[1] = parseInt(e[1], 10) || 0, e[2] = parseInt(e[2], 10) || 0, t[0] > e[0] || t[0] == e[0] && t[1] > e[1] || t[0] == e[0] && t[1] == e[1] && t[2] >= e[2]
    }

    function p(e, t, i, n) {
      if (!B.ie || !B.mac) {
        var r = P.getElementsByTagName("head")[0];
        r && (i = i && "string" == typeof i ? i : "screen", n && (E = A = null), A && E == i || ((n = P.createElement("style")).setAttribute("type", "text/css"), n.setAttribute("media", i), A = r.appendChild(n), B.ie && B.win && void 0 !== P.styleSheets && 0 < P.styleSheets.length && (A = P.styleSheets[P.styleSheets.length - 1]), E = i), B.ie && B.win ? A && "object" == typeof A.addRule && A.addRule(e, t) : A && void 0 !== P.createTextNode && A.appendChild(P.createTextNode(e + " {" + t + "}")))
      }
    }
    ...
    function m(e, t) {
      if (N) {
        ...
        x && h(e) ? h(e).style.visibility = i : p("#" + e, "visibility:" + i)
      }
    }
    ...
    var v, y, b, w, A, E, S = window,
      ...
      B = function () {
        var e = void 0 !== P.getElementById && void 0 !== P.getElementsByTagName && void 0 !== P.createElement,
          ...
          n = /win/.test(i || t),
          r = (i = /mac/.test(i || t), t = !!/webkit/.test(t) && parseFloat(t.replace(/^.*webkit\/(\d+(\.\d+)?).*$/, "$1")), !1),
          o = [0, 0, 0],
          a = null;
        if (void 0 !== C.plugins && "object" == typeof C.plugins["Shockwave Flash"]) !(a = C.plugins["Shockwave Flash"].description) || void 0 !== C.mimeTypes && C.mimeTypes["application/x-shockwave-flash"] && !C.mimeTypes["application/x-shockwave-flash"].enabledPlugin || (T = !0, r = !1, a = a.replace(/^.*\s+(\S+\s+\S+$)/, "$1"), o[0] = parseInt(a.replace(/^(.*)\..*$/, "$1"), 10), o[1] = parseInt(a.replace(/^.*\.(.*)\s.*$/, "$1"), 10), o[2] = /[a-zA-Z]/.test(a) ? parseInt(a.replace(/^.*[a-zA-Z]+(.*)$/, "$1"), 10) : 0);
        else if (void 0 !== S.ActiveXObject) try {
          var s = new ActiveXObject("ShockwaveFlash.ShockwaveFlash");
          s && (a = s.GetVariable("$version")) && (r = !0, a = a.split(" ")[1].split(","), o = [parseInt(a[0], 10), parseInt(a[1], 10), parseInt(a[2], 10)])
        } catch (e) {}
        return {
          w3: e,
          pv: o,
    ...
    return B.w3 && ((void 0 !== P.readyState && "complete" == P.readyState || void 0 === P.readyState && (P.getElementsByTagName("body")[0] || P.body)) && e(), x || (void 0 !== P.addEventListener && P.addEventListener("DOMContentLoaded", e, !1), B.ie && B.win && (P.attachEvent("onreadystatechange", function () {
    ...
    }(), i(e))), B.ie && B.win && window.attachEvent("onunload", function () {
      ...
      registerObject: function (e, t, i, n) {
        if (B.w3 && e && t) {
          var r = {};
          r.id = e, r.swfVersion = t, r.expressInstall = i, r.callbackFn = n, I[I.length] = r, m(e, !1)
        } else n && n({
          success: !1,
          id: e
        })
      ...
      embedSWF: function (e, i, n, r, s, l, c, d, h, p) {
        var g = {
          success: !1,
          id: i
        };
        B.w3 && !(B.wk && 312 > B.wk) && e && i && n && r && s ? (m(i, !1), t(function () {
          n += "", r += "";
          var t = {};
          if (h && "object" == typeof h)
            for (var v in h) t[v] = h[v];
          if (t.data = e, t.width = n, t.height = r, v = {}, d && "object" == typeof d)
            for (var y in d) v[y] = d[y];
          if (c && "object" == typeof c)
            for (var b in c) v.flashvars = void 0 !== v.flashvars ? v.flashvars + "&" + b + "=" + c[b] : b + "=" + c[b];
          if (f(s)) y = u(t, v, i), t.id == i && m(i, !0), g.success = !0, g.ref = y;
          else {
            if (l && o()) return t.data = l, void a(t, v, i, p);
            m(i, !0)
          }
          p && p(g)
        })) : p && p(g)
      ...
      getQueryParamValue: function (e) {
        if (t = P.location.search || P.location.hash) {
          if (/\?/.test(t) && (t = t.split("?")[1]), null == e) return g(t);
          for (var t = t.split("&"), i = 0; i < t.length; i++)
            if (t[i].substring(0, t[i].indexOf("=")) == e) return g(t[i].substring(t[i].indexOf("=") + 1))
        }
        return ""
      },
      expressInstallCallback: function () {
        if (M) {
          ...
          e && v && (e.parentNode.replaceChild(v, e), y && (m(y, !0), B.ie && B.win && (v.style.display = "block")), b && b(w)), M = !1
        }
      }
    }
  }();
  ! function (i, n) {
    var r = {
      ...
      o = function () {
        for (var e, t, i, r, o, a, s, l = 0, u = arguments; l < u.length && !a;) {
          var c = u[l],
            d = u[l + 1];
          if (void 0 === e)
            for (r in e = {}, d) d.hasOwnProperty(r) && ("object" == typeof (o = d[r]) ? e[o[0]] = n : e[o] = n);
          for (t = i = 0; t < c.length && !a;)
            if (a = c[t++].exec(this.getUA()))
              for (r = 0; r < d.length; r++) s = a[++i], "object" == typeof (o = d[r]) && 0 < o.length ? 2 == o.length ? e[o[0]] = "function" == typeof o[1] ? o[1].call(this, s) : o[1] : 3 == o.length ? e[o[0]] = "function" != typeof o[1] || o[1].exec && o[1].test ? s ? s.replace(o[1], o[2]) : n : s ? o[1].call(this, s, o[2]) : n : 4 == o.length && (e[o[0]] = s ? o[3].call(this, s.replace(o[1], o[2])) : n) : e[o] = s || n;
          l += 2
        }
        return e
      },
    ...
    u.VERSION = "0.7.10", u.BROWSER = {
      ...
      NAME: "name",
      VERSION: "version"
    }, void 0 !== e && e.exports && (t = e.exports = u), t.UAParser = u;
  ...
  void 0 === (n = window).EmanageCRMJS && (n.EmanageCRMJS = function e() {
    var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
    ! function (e, t) {
      if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
    }(this, e), this.webkey = void 0 === t.webkey ? "" : t.webkey, this.cid = void 0 === t.cid ? "" : t.cid, this.lang = void 0 === t.lang ? "" : t.lang, this.successUrl = void 0 === t.successUrl ? "" : t.successUrl, this.declineUrl = void 0 === t.declineUrl ? "" : t.declineUrl, this.isTest = void 0 !== t.isTest && t.isTest, this.utils = {
      getPaymentTypes: r.default.getPaymentTypes,
      getParameter: r.default.getParameter
    }, this.Campaign = new o.default(this.webkey, this.cid, t.baseGetAPIEndpoint), this.Order = new a.default(this.webkey, this.cid, this.isTest, t.basePostAPIEndpoint)
  })
}, function (e, t, i) {
  e.exports = i(10)
}]);
